...
% 修正：Yimin Wu
% 来源：CSDN 
% 原文：https://blog.csdn.net/lusongno1/article/details/50411840 
...
[sourcefile, status] = urlread(sprintf('http://vip.stock.finance.sina.com.cn/corp/go.php/vMS_MarketHistory/stockid/000001/type/S.phtml?year=%d&jidu=%d',year,season));
...
xlswrite('C:/Users/吴奕旻/Documents/MATLAB/Yitu/spider/data', items, sheet)
xlswrite('C:/Users/吴奕旻/Documents/MATLAB/Yitu/spider/data', date' , sheet,'A2'); %在第一列写入日期
range = sprintf('B2:%s%d',char(double('B')+size(data,2)-1), size(data,1)+1); %从源文件中获取的目标数据的放置范围
xlswrite('C:/Users/吴奕旻/Documents/MATLAB/Yitu/spider/data', data, sheet, range);
fprintf('完成!\n')
end

fprintf('全部完成！数据保存在data表格中，请注意查看！\n')